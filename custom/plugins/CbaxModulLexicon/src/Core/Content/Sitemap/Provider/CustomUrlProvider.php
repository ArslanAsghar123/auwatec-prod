...
class CustomUrlProvider extends AbstractUrlProvider
{
    ...
    {
        $urls = [];
        $pluginConfig = $this->systemConfigService->get(Database::CONFIG_PATH, $context->getSalesChannelId());
    ...
    private function getLexikonSeoUrls(SalesChannelContext $salesChannelContext, int $limit, ?int $offset): array
    {
        $urls = [];
