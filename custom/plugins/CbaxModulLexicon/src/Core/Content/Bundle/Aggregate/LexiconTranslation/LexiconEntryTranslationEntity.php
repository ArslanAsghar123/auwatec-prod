...
class LexiconEntryTranslationEntity extends TranslationEntity
{
    ...
    public function getCbaxLexiconEntry(): string
    {
        return $this->cbaxLexiconEntry;
    }

    public function setCbaxLexiconEntry(string $cbaxLexiconEntry): void
    {
        $this->cbaxLexiconEntry = $cbaxLexiconEntry;
    }
