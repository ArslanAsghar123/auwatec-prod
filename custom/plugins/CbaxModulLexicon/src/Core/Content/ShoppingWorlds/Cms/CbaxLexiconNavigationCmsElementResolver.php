...
class CbaxLexiconNavigationCmsElementResolver extends AbstractCmsElementResolver
{
    ...
    public function enrich(CmsSlotEntity $slot, ResolverContext $resolverContext, ElementDataCollection $result): void
    {
        ...
        $entriesByChar = $this->getNavigationData($salesChannelContext->getContext(), $salesChannelId);

        $data = new ArrayStruct($entriesByChar);
        $slot->setData($data);
    }

    private function getNavigationData(Context $context, string $salesChannelId): array
    {
