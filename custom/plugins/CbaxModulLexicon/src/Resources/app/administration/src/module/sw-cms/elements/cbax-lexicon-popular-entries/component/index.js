import template from './sw-cms-el-cbax-lexicon-popular-entries.html.twig';
import './sw-cms-el-cbax-lexicon-popular-entries.scss';

const { Component, Mixin } = Shopware;

Component.register('sw-cms-el-cbax-lexicon-popular-entries', {
    template,
