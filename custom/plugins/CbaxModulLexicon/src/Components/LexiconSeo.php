...
class LexiconSeo
{
	...
	public function getSeoUrls(string $route_name, Context $context, string $salesChannelId): array
	{
    ...
    public function createSeoUrls(Context $context, ?string $locale): array
    {
        ...
        $salesChannels = $this->lexiconHelper->getStorefrontSalesChannel($context);
        ...
        foreach ($salesChannels as $salesChannel)
        {
            ...
            $config = $this->systemConfigService->get(Database::PLUGIN_NAME, $salesChannelId)['config'];
        ...
        if (count($errorSeoUrls) > 0) {
            $this->lexiconHelper->doShopwareLog($errorSeoUrls, $errorMessage, $context, 'Error', 'Lexikon - create Seo Urls');
        }
