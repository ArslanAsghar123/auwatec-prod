# 4.1.3
- Fix: Namespace typo error of the new event

# 4.1.2
- New: Event added to LexiconReplacer Component with Keywords Array
- Feature: Performance improved

# 4.1.1
- Fix: Problem with certain product records when importing the link of migrated lexicon entries

# 4.1.0
- Fix: Update error with a high MySql version fixed
- Fix: Fixed an error when loading a JS script
- Fix: Fixed bug when certain products were added to the shopping cart

# 4.0.9
- Feature: Accessibility improvements added
- Fix: Properties were not taken into account on product pages in CMS format - fixed

# 4.0.8
- Feature: CSS class is-lexicon moved to container-main

# 4.0.7
- New: Migration function Shopware 5 -> Shopware 6 installed
- Feature: img tags are now excluded from the replacement function

# 4.0.6
- Fix: Lexicon navigation in mobile phone view
- Fix: New lexicon entry can no longer be saved without a title or keyword

# 4.0.5
- Feature: Extended meta title now optional with plugin settings button
- Fix: Admin snippets in SW 6.6.4 error

## 4.0.4
- Feature: Lexicon breadcrumb changed to match structure and classes of SW breadcrumb
- Fix: Metatitel back to original form
- Fix: SW CMS video elements on lexicon pages

## 4.0.3
- Feature: Breadcrumb navigation paths are now recognized by Google

## 4.0.2
- New: Option to skip seo url loading with modal replacement for better loading times

## 4.0.1
- Fix: Error with language-dependent lexicon page links

# 4.0.0
- Adaptation to Shopware 6.6

## 3.1.6
- Fix: Small CSS adjustments in the frontend
- New: Optional extension of the storefront search with lexicon entries

## 3.1.5
- Fixed: Hints in the plugin settings improved
- New: Lexicon entry links to modal window now in mobil view, too

## 3.1.4
- New: Specifications for robots meta tag are optionally selectable in plugin settings for lexicon overview page
- New: Specifications for robots meta tag are optionally selectable in plugin settings for lexicon detail page
- New: Specifications for robots meta tag are optionally selectable in plugin settings for lexicon listing page
- New: Specifications for robots meta tag are optionally selectable in plugin settings for lexicon content page
...
- Fix: No seo url creation when plugin in sales-channel not active 
- Fix: No sitemap url creation when plugin in sales-channel not active
...
* Lexicon replacements also in selectable product custom-fields
