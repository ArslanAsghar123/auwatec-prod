...
class TwitterDescriptionSaver extends AbstractSaver
{
    ...
    public function isValid(SeoDataSaverStruct $seoDataSaverStruct, ?SeoDataFetchResultStruct $currentSeoDataFetchResultStruct): bool
    {
        ...
        return $this->isWritable(
            !(null !== $currentSeoDataFetchResultStruct->getTwitterDescription() && false === $currentSeoDataFetchResultStruct->isInheritedTwitterDescription()),
            $seoDataSaverStruct,
...
//             */
//            if (null !== $seoDataFetchResultStruct->getTwitterDescription() && false === $seoDataFetchResultStruct->isInheritedTwitterDescription()) {
//                return;
//            }
//        }
        ...
        $update = [
            ...
            'translations' => [
                $languageId => [
                    'customFields' => [
                        CategoryEnum::CUSTOM_FIELD__DREISC_SEO_TWITTER_DESCRIPTION => $newValue
                    ]
                ]
            ]
        ];
