...
class FacebookDescriptionSaver extends AbstractSaver
{
    ...
    public function isValid(SeoDataSaverStruct $seoDataSaverStruct, ?SeoDataFetchResultStruct $currentSeoDataFetchResultStruct): bool
    {
        ...
        return $this->isWritable(
            !(null !== $currentSeoDataFetchResultStruct->getFacebookDescription() && false === $currentSeoDataFetchResultStruct->isInheritedFacebookDescription()),
            $seoDataSaverStruct,
...
//             */
//            if (null !== $seoDataFetchResultStruct->getFacebookDescription() && false === $seoDataFetchResultStruct->isInheritedFacebookDescription()) {
//                return;
//            }
//        }
        ...
        $update = [
            ...
            'translations' => [
                $languageId => [
                    'customFields' => [
                        CategoryEnum::CUSTOM_FIELD__DREISC_SEO_FACEBOOK_DESCRIPTION => $newValue
                    ]
                ]
            ]
        ];
