...
class TwitterTitleSaver extends AbstractSaver
{
    ...
    public function isValid(SeoDataSaverStruct $seoDataSaverStruct, ?SeoDataFetchResultStruct $currentSeoDataFetchResultStruct): bool
    {
        ...
        return $this->isWritable(
            !(null !== $currentSeoDataFetchResultStruct->getTwitterTitle() && false === $currentSeoDataFetchResultStruct->isInheritedTwitterTitle()),
            $seoDataSaverStruct,
...
//             */
//            if (null !== $seoDataFetchResultStruct->getTwitterTitle() && false === $seoDataFetchResultStruct->isInheritedTwitterTitle()) {
//                return;
//            }
//        }
        ...
        $update = [
            ...
            'translations' => [
                $languageId => [
                    'customFields' => [
                        CategoryEnum::CUSTOM_FIELD__DREISC_SEO_TWITTER_TITLE => $newValue
                    ]
                ]
            ]
        ];
