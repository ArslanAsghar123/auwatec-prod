...
class MetaTitleSaver extends AbstractSaver
{
    ...
    public function isValid(SeoDataSaverStruct $seoDataSaverStruct, ?SeoDataFetchResultStruct $currentSeoDataFetchResultStruct): bool
    {
        ...
        return $this->isWritable(
            !(null !== $currentSeoDataFetchResultStruct->getMetaTitle() && false === $currentSeoDataFetchResultStruct->isInheritedMetaTitle()),
            $seoDataSaverStruct,
...
//             * - meta title is not null AND
//             * - it's not an inherit value
//             */
//            if (null !== $seoDataFetchResultStruct->getMetaTitle() && false === $seoDataFetchResultStruct->isInheritedMetaTitle()) {
//                return;
//            }
//        }
