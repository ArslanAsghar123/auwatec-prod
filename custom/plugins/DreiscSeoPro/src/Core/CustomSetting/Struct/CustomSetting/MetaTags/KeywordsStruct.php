...
class KeywordsStruct extends AbstractCustomSettingStruct
{
    final const DEFAULT__LENGTH_CONFIG__RECOMMENDED_LENGTH_START = 30;
    final const DEFAULT__LENGTH_CONFIG__RECOMMENDED_LENGTH_END = 255;
    final const DEFAULT__LENGTH_CONFIG__MAX_LENGTH = 255;
    ...
    public function setLengthConfig(LengthConfigStruct $lengthConfig): KeywordsStruct
    {
