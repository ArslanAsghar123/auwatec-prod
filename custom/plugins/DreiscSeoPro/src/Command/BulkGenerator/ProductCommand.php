...
{    public function __construct(
    ...
    {
        $this->setName('dreisc-seo:bulk-generator:product')
            ->setDescription('Starts the generation of the product bulk templates')
            ...
            ->addOption(
                ...
                null,
                InputOption::VALUE_OPTIONAL,
                'Product ids separated by commas that should be created. If this parameter is specified, the bulk generator for the specified products is started directly.',
                null
            );
    }
