...
use Shopware\Core\Checkout\Cart\Price\GrossPriceCalculator as ParentClass;
...
class GrossPriceCalculator extends ParentClass
{
    public function __construct(
        ...
        parent::__construct($taxCalculator,$this->priceRounding);
    }
