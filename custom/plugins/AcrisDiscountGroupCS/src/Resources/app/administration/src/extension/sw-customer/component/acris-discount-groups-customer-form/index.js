import template from './acris-discount-groups-customer-form.html.twig';
...
Component.register('acris-discount-groups-customer-form', {
    template,
    ...
    methods: {
        ...
        onConfirmDelete() {
            ...
            this.$nextTick(() => {
                this.customer.extensions.acrisDiscountGroups.remove(this.acrisDiscountGroup.id);
            });
        },
