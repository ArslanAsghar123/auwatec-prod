...
namespace Atl\SeoUrlManager\Core\Content\Sitemap\Provider;
...
class ProductUrlProvider extends AbstractUrlProvider
{
     ...
     */
    private AbstractUrlProvider $decoratedService;
    ...
    public function __construct(
        ...
        AbstractUrlProvider $abstractUrlProvider,
    ...
    {
        $this->decoratedService = $abstractUrlProvider;
    ...
    {
        $parentSitemapUrlsConfig = $this->systemConfigService->get('AtlSeoUrlManager.config.parentSitemapUrls');

        if (!$parentSitemapUrlsConfig) {
            return $this->decoratedService->getUrls($context, $limit, $offset);
        }
