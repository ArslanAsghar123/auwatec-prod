...
use Acris\Gpsr\Custom\GpsrManufacturerEntity;
use Shopware\Core\Framework\DataAbstractionLayer\EntityCustomFieldsTrait;
use Shopware\Core\Framework\DataAbstractionLayer\TranslationEntity;

class GpsrManufacturerTranslationEntity extends TranslationEntity
{
    ...
    protected ?string $gpsrManufacturerId = null;
    protected ?GpsrManufacturerEntity $gpsrManufacturer = null;
    ...
    public function getGpsrManufacturerId(): ?string
    {
        return $this->gpsrManufacturerId;
    }

    public function setGpsrManufacturerId(?string $gpsrManufacturerId): void
    {
        $this->gpsrManufacturerId = $gpsrManufacturerId;
    }

    public function getGpsrManufacturer(): ?GpsrManufacturerEntity
    {
        return $this->gpsrManufacturer;
    }

    public function setGpsrManufacturer(?GpsrManufacturerEntity $gpsrManufacturer): void
    {
        $this->gpsrManufacturer = $gpsrManufacturer;
    }
