...
use Acris\Gpsr\Custom\Aggregate\GpsrProductDownloadTranslation\GpsrProductDownloadTranslationDefinition;
...
class ProductGpsrDownloadDefinition extends EntityDefinition
{
    public CONST ENTITY_NAME = 'acris_gpsr_p_d';
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new StringField('gpsr_type', 'gpsrType'))->addFlags(new ApiAware()),
            ...
            (new TranslationsAssociationField(GpsrProductDownloadTranslationDefinition::class, 'acris_gpsr_p_d_id'))->addFlags(new ApiAware()),
        ]);
    }
}
